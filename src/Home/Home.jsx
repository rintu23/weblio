export default function HeroSection() {
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-100 overflow-hidden" data-aos="fade-up">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 lg:items-center">
            ...
            <div className="text-center lg:text-left lg:col-span-6 animate-fade-in-up">
              <h1>
                ...
                <span className="mt-2 block text-4xl tracking-tight font-extrabold sm:text-5xl xl:text-6xl leading-tight text-gray-900">
              ...
              <div className="mt-8">
                <a
                  href="/contact"
                  className="inline-block px-8 py-3 text-lg font-semibold text-white bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 ease-in-out"
                >
                  Get Started
                </a>
              </div>
...
<div className="mt-12 lg:mt-0 lg:col-span-6 flex justify-center animate-fade-in">
  <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-xl">
    <div className="relative block w-full bg-white bg-opacity-60 backdrop-blur-md rounded-xl shadow-lg overflow-hidden">
